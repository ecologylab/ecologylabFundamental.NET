    ...
    public class OODSSClient 
    {
        ...
        public ElementState GetResponse(ElementState request,SimplTypesScope ts=null)
        {
            ...
            try
            {
                ...
                string rq = SimplTypesScope.Serialize(request, StringFormat.Xml);

                String sendMessage = message_for_xml(rq);
                ...
                responseElementState = (ElementState) translationScope.Deserialize(stringData, StringFormat.Xml);
        ...
        int lastServed = -1;
        public async Task<ElementState> GetRequestAsync(ElementState elementState, SimplTypesScope translationScope)
        {
        ...
        struct QueueObject
        {
            ...
            public QueueObject(ElementState elementState, SimplTypesScope translationScope, int callNumber)
            {
